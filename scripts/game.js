...
var State = function(old) {
    ...
    this.isTerminal = function() {
        ...
        for(var i = 0; i <= 6; i = i + 3) {
            if(B[i] !== "F" && B[i] === B[i + 1] && B[i + 1] == B[i + 2]) {
        ...
        //check columns
        for(var i = 0; i <= 2 ; i++) {
            if(B[i] !== "F" && B[i] === B[i + 3] && B[i + 3] === B[i + 6]) {
                this.result = B[i] + "-won"; //update the state result
                return true;
            }
        }
        ...
        for(var i = 0, j = 4; i <= 2 ; i = i + 2, j = j - 2) {
            if(B[i] !== "F" && B[i] == B[i + j] && B[i + j] === B[i + 2*j]) {
                this.result = B[i] + "-won"; //update the state result
                return true;
            }
        }
...
/*
  function that calculates the score of the x player in a given terminal state in which the score is calculated and the score calculated for the human player
 */
